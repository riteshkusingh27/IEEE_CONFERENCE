        ...
        <table className='w-full border-collapse border border-blue-300'>
          <thead>
            <tr className='bg-blue-300 text-lg font-normal'>
              ...
              <th className='border border-blue-300 px-4 py-2 text-left'>Discount on Registration Fee </th>
            </tr>
          </thead>
          <tbody>
            <tr className='bg-blue-200 text-lg font-normal'>
              <td className='border border-blue-300 px-4 py-2'>15<sup>th</sup> November  -  30<sup>th</sup> November</td>
